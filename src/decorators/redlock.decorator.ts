...
import type { RedlockDecoratorOptions } from '../interfaces/redlock-decorator-options.interface';
...
export function Redlock(options: RedlockDecoratorOptions): MethodDecorator {
  ...
  return (
    ...
    descriptor: TypedPropertyDescriptor<any> // eslint-disable-line @typescript-eslint/no-explicit-any
  ) => {
    ...
    descriptor.value = async function (
      ...
      try {
        ...
        if (options.retryAttempts !== undefined) lockOptions.retryAttempts = options.retryAttempts;
